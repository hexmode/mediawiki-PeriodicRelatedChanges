...
Read the [[https://github.com/hexmode/mediawiki-PeriodicRelatedChanges/blob/master/doc/User_manual.mediawiki][user manual]] to understand how to use this tool better.
